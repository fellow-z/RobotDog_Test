...
{
	snycWrite(FR_Leg.IDs, 3, 0x1E, (uint16_t*)FR_Leg.position);
	snycWrite(FL_Leg.IDs, 3, 0x1E, (uint16_t*)FL_Leg.position);
	snycWrite(BL_Leg.IDs, 3, 0x1E, (uint16_t*)BL_Leg.position);
	snycWrite(BR_Leg.IDs, 3, 0x1E, (uint16_t*)BR_Leg.position);
}
